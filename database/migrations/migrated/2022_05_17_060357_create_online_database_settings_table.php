...
class CreateOnlineDatabaseSettingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('online_database_settings', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('online_database_settings');
    }
}
