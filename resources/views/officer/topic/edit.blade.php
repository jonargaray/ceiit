...
@section ('body')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h1>
                <a href="{{ route('officer.questions.exercise', $topic->prog_language_id) }}"><i class="fa fa-fw fa-arrow-left text-black"></i></a>
                New Topic</h1>
            <ol class="breadcrumb">
        ...
        <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="ibox ">
                        ...
                        <form method="post" action="{{ route('officer.topics.update', $topic->id) }}" onsubmit="btnSubmit.disabled = true">
                            <div class="ibox-content">
                                ...
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Topic <span class="text-danger">*</span></label>
                                    <div class="col-sm-4"> 
                                        <input type="text" value="{{$topic->topic}}" name="topic" autofocus class="form-control" required />
                                    </div>
                                </div>
