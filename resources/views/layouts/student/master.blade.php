...
<head>
  ...
  <link rel="stylesheet" href="{{ url('css/plugins/bootstrap-tagsinput/bootstrap-tagsinput.css') }}">
...
<body class="top-navigation">
  ...
  <!-- Mainly scripts -->
    ...
    <script type="text/javascript" src="{{ url('js/demo/chartjs-demo.js') }}"></script>
