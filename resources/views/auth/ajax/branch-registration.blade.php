<div class="form-group row"><label class="col-sm-3 col-form-label">Business Name <span class="text-danger pull-right">*</span></label>
    <div class="col-sm-6">
        <input readonly id="email" type="text" autocomplete="nope" class="form-control  @error('business_name') is-invalid @enderror" placeholder="Bakeshop" name="business_name" required="" value="{{ $subscriber->business_name }}"  autofocus>
        @error('business_name')
...
<br>
<h3 class="font-normal">Branch Address</h3>
<hr>
